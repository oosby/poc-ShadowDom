...
Handlebars.registerHelper('eachWithIterator', function(context, options) {
  var out = "", data;
  ...
  return out;
    ...
    if (typeof context === 'string' && context.indexOf(options.hash.compare) !== -1)
